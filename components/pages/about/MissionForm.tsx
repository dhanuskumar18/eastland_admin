...
export default function MissionForm({ section }: Props) {
  ...
  const handleSave = async () => {
    ...
    const content = { ...baseContent, title, image, description };
    ...
    updateSection({ id: section.id, data: { name: section.name, pageId: section.pageId, translations: [{ "locale": 'en', "content": content }] } }, {
      onSuccess: () => showToast({ type: 'success', title: 'Saved', message: 'Mission updated.' }),
        ...
        <div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="relative w-32 h-24 border border-gray-300 rounded flex-shrink-0">
              <img src="/api/placeholder/130/100" alt="Mission" className="w-full h-full object-cover rounded" />
