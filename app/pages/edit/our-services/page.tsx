...
const ourServicesSections = [
  ...
  { id: 3, name: "Kitchen Installation" },
  { id: 4, name: "About Our Services" }
];

export default function EditOurServicesPage() {
  const [editingSection, setEditingSection] = useState<string | null>(null);
  const [sections] = useState(ourServicesSections);
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-semibold text-gray-800">Our Services Sections</h1>
          ...
          <div key={section.id}>
            ...
            {editingSection === section.name && (
              <>
                ...
                {section.name === 'Our Services' && <OurServicesForm />}
                {section.name === 'Kitchen Installation' && <KitchenInstallationForm />}
                {section.name === 'About Our Services' && <AboutOurServicesForm />}
              </>
            )}
          </div>
        ))}
