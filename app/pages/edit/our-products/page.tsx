...
const ourProductsSections = [
  { id: 1, name: "Banner" },
  { id: 2, name: "Our Products" },
  { id: 3, name: "Quick Installation", hasNewButton: true, newButtonLabel: "Add New Step" },
  { id: 4, name: "About Our Products" }
];

export default function EditOurProductsPage() {
  const [editingSection, setEditingSection] = useState<string | null>(null);
  const [sections] = useState(ourProductsSections);
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-semibold text-gray-800">Our Products Sections</h1>
          ...
          <div key={section.id}>
            ...
            {editingSection === section.name && (
              <>
                ...
                {section.name === 'Our Products' && <OurProductsForm />}
                {section.name === 'Quick Installation' && <QuickInstallationForm />}
                {section.name === 'About Our Products' && <AboutOurProductsForm />}
              </>
            )}
          </div>
        ))}
