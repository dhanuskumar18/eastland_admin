...
export default function EditContactUsPage() {
  ...
  const [sections] = useState(contactSections);
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-semibold text-gray-800">Contact Us Sections</h1>
          ...
          <div key={section.id}>
            ...
            {editingSection === section.name && (
              <>
                ...
                {section.name === 'Contact Information' && <ContactInfoForm />}
                {section.name === 'Contact Form' && <ContactFormConfigForm />}
              </>
            )}
          </div>
        ))}
